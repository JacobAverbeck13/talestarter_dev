...
<div class="container-fluid">
		...
		<h2>Main Goals</h2>
			...
			<li class="col-lg-12">
				<p style="font-size:18px;">
					This website is designed to give new or casual writers a medium for conceiving,
					structuring, writing, editing, and publishing new stories.
				</p>
			</li>
			<li class="col-lg-12">
				<p style="font-size:18px;">
	...
	<div class="row">
		...
		<h2>Why Use TaleStarter?</h2>
			...
			<p class="col-lg-12" style="font-size:20px;">
				<strong>Contributors</strong>: TaleStarter includes a task distribution system 
